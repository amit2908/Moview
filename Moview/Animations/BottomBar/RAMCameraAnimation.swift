...
class RAMCameraAnimation:RAMItemAnimation {
    ...
    public var finalTranslationValue : Float = -10.0
    ...
    open override func playAnimation(_ imageView : UIImageView, textLabel lbl : UILabel) {
        ...
        DispatchQueue.global(qos: .default).async {
            ...
            DispatchQueue.main.async {
                ...
                animationGroup.animations = [self.createRotationAnimation(), self.createFadeAnimation()]
